...
dividedlg::dividedlg(Document_Interface *doc, const QString &passedData,
    ...
    auto *leftcolayout = new QVBoxLayout;
    ...
    auto *G1 = new QGroupBox();
    G1->setFont(font2);
    G1->setTitle(tr("Layers"));
    G1->setVisible(true);
    leftcolayout->addWidget(G1);

    auto *BB1 = new QDialogButtonBox();
    ...
    QObject::connect(BB1, &QDialogButtonBox::accepted, this, &dividedlg::onOkClickedSlot);
    QObject::connect(BB1, &QDialogButtonBox::rejected, this, &dividedlg::reject);

    auto *fr1layout = new QHBoxLayout;
    ...
    auto *fr2layout = new QHBoxLayout;
    ...
    Sp1->setMinimum(0);
    Sp1->setValue(0);
    QObject::connect(Sp1, static_cast<void (QSpinBox::*)(int)>(&QSpinBox::valueChanged),
                     this, &dividedlg::onQtyChangedSlot);
    ...
    Sp2->setMinimum(1);
    Sp2->setValue(5);
    QObject::connect(Sp2, static_cast<void (QSpinBox::*)(int)>(&QSpinBox::valueChanged),
                     this, &dividedlg::onSizeChangedSlot);
    ...
    QObject::connect(R1, &QRadioButton::toggled,
                     this, &dividedlg::onOffTicksSlot);
    ...
    QObject::connect(R2, &QRadioButton::toggled, this, &dividedlg::onOffBreaksSlot);

    QList<QString> layerList = doc->getAllLayer();
    QString activeLayerName = doc->getCurrentLayer();
    QString num;
    auto *laylayout = new QGridLayout;
    ...
    for (int i = 0; i < layerList.size(); i++) {
        ...
        QObject::connect(RB, &QRadioButton::toggled, this, &dividedlg::onWhichButtonSlot);
    ...
    auto *g1layout = new QVBoxLayout;
    G1->setLayout(g1layout);

    auto *Sa1 = new QScrollArea(G1);
    ...
    auto *newlaylayout = new QHBoxLayout;
    auto *L5 = new QLabel(G1);
    ...
    auto *rtcolayout = new QVBoxLayout;
    ...
    if (entType == "line") {
        ...
        auto *anglayout = new QVBoxLayout();
        ...
        auto *doubleVal = new QDoubleValidator
        ...
        QObject::connect(Le1, &QLineEdit::textChanged, this, &dividedlg::onStartAngleChangedSlot);
...
QFrame *dividedlg::choice(ElementKind ek, const QFont &font) {
    ...
    auto *tickloclayout = new QVBoxLayout;
    Cr1->setLayout(tickloclayout);

    auto *C1 = new QLabel(Cr1);
    ...
    auto *tickchoiceslayout = new QHBoxLayout;
    tickloclayout->addLayout(tickchoiceslayout);

    auto *r1 = new QRadioButton(C1);
    tickchoiceslayout->addWidget(r1);
    r1->setText(msg2);
    r1->setObjectName("o");
    QObject::connect(r1, &QRadioButton::toggled, this, &dividedlg::onInOutSlot);
    r1->setChecked(true);

    auto *r2 = new QRadioButton(C1);
    tickchoiceslayout->addWidget(r2);
    r2->setText(msg3);
    r2->setObjectName("i");
    QObject::connect(r2, &QRadioButton::toggled, this, &dividedlg::onInOutSlot);
