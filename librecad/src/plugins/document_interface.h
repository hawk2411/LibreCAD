...
public:
    ...
    */
    ...
    virtual bool addVariable(const QString& key, int value, int code) = 0;   //code=70
    virtual bool addVariable(const QString& key, double value, int code) = 0; //code=40
