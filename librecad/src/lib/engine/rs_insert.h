...
private:
    RS_InsertData _data;
    mutable RS_Block *_block;

    void update_local();

    RS_Entity *createNewEntity(const bool isScaleFactorValid, RS_Entity *entity);
};
