...
public:
    ...
    virtual std::string fromUtf8(const std::string &s)const {return s;}
    virtual std::string toUtf8(const std::string &s);
    std::string encodeText(const std::string& stmp);
    static std::string decodeText(int c);
    static std::string encodeNum(int c);
    static int decodeNum(const std::string& s, int *b);
...
public:
    ...
    std::string fromUtf8(const std::string &s) const override;
